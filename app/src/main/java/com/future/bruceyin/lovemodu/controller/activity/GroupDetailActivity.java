...
import com.future.bruceyin.lovemodu.controller.adapter.GroupDetailAdapter;
...
public class GroupDetailActivity extends Activity {
    ...
    private void initGridView() {
        //当前用户是群主  或者 群是公开的
        boolean idCanModify = EMClient.getInstance().getCurrentUser().equals(mGroup.getOwner()) || mGroup.isPublic();
        groupDetailAdapter = new GroupDetailAdapter(this, idCanModify, mOnGroupDetailListener);
    ...
    private void initButtonDisplay() {
        ...
        //判断当前用户是否为群主
        if (EMClient.getInstance().getCurrentUser().equals(mGroup.getOwner())) {//群主的处理
